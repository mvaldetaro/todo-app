        ...
        return (
            <div role='form' className='todoForm'>
                ...
                <Grid cols='12 3 2'>
                    ...
                    <IconButton style='defualt' icon='close' onClick={this.props.handleClear}></IconButton>
                </Grid>
            </div>
        )
    }
...
const maspStateToProps = state => ({ description: state.todo.description})
const mapDispatchToProps = dispatch => bindActionCreators({add, changeDescription, search}, dispatch)
export default connect(maspStateToProps, mapDispatchToProps)(TodoForm)